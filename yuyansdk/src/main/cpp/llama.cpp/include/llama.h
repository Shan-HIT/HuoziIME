...
extern "C" {
    ...
    LLAMA_API void llama_memory_seq_cp(
        ...
        // Overlay-copy sequence data from src to dst for positions in [p0, p1).
        // Unlike llama_memory_seq_cp(), this preserves existing dst sequence KV outside the range.
        // Intended for advanced KV-splice use cases.
        LLAMA_API void llama_memory_seq_cp_overlay(
                        llama_memory_t mem,
                            llama_seq_id seq_id_src,
                            llama_seq_id seq_id_dst,
                                 llama_pos p0,
