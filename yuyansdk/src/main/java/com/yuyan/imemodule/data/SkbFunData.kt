...
val menuSkbFunsPreset: Map<SkbMenuMode, SkbFunItem> = hashMapOf(
    ...
    SkbMenuMode.StyleSwitch to SkbFunItem("风格切换", R.drawable.ic_menu_flower, SkbMenuMode.StyleSwitch),
    SkbMenuMode.ModeSwitch to SkbFunItem("模式切换", R.drawable.ic_menu_keyboard, SkbMenuMode.ModeSwitch),
    SkbMenuMode.MemoryPanel to SkbFunItem("记忆", R.drawable.ic_menu_phrases, SkbMenuMode.MemoryPanel)
)
