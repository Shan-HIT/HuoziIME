...
object ThemePreset {
    val TechAI_BUSINESS = Theme.Builtin(
        name = "TechAI_BUSINESS",
        isDark = false, 
        keyboardResources = 0x0,
        
        barColor = 0xffE0F2F7, 
        keyboardColor = 0xffF1F8FB, 
        keyBackgroundColor = 0xffC5E1F2, 
        keyTextColor = 0xff37474F, 
        accentKeyBackgroundColor = 0xff4FC3F7, 
        accentKeyTextColor = 0xffFFFFFF, 
        keyPressHighlightColor = 0x334FC3F7, 
        popupBackgroundColor = 0xffBBDEFB, 
        functionKeyBackgroundColor = 0xffA7D7EF, 
        functionKeyPressHighlightColor = 0x334FC3F7, 
    ).also { Log.d("ThemePreset", "TechAI_BUSINESS 主题已加载。") }

    val TechAI_WARM = Theme.Builtin(
        name = "TechAI_WARM",
        isDark = false, 
        keyboardResources = 0x0,
        
        barColor = 0xffE8F5E9, 
        keyboardColor = 0xffF3FDF4, 
        keyBackgroundColor = 0xffC8E6C9, 
        keyTextColor = 0xff388E3C, 
        accentKeyBackgroundColor = 0xff81C784, 
        accentKeyTextColor = 0xffFFFFFF, 
        keyPressHighlightColor = 0x3381C784, 
        popupBackgroundColor = 0xffA5D6A7, 
        functionKeyBackgroundColor = 0xff99D29A, 
        functionKeyPressHighlightColor = 0x3381C784, 
    ).also { Log.d("ThemePreset", "TechAI_WARM 主题已加载。") }

    val TechAI_INRERNET = Theme.Builtin(
        name = "TechAI_INRERNET",
        isDark = false, 
        keyboardResources = 0x0,
        
        barColor = 0xffFFCDD2, 
        keyboardColor = 0xffFFEBEE, 
        keyBackgroundColor = 0xffEF9A9A, 
        keyTextColor = 0xff7F0000, 
        accentKeyBackgroundColor = 0xffF44336, 
        accentKeyTextColor = 0xffFFFFFF, 
        keyPressHighlightColor = 0x33F44336, 
        popupBackgroundColor = 0xffE57373, 
        functionKeyBackgroundColor = 0xffEF9A9A, 
        functionKeyPressHighlightColor = 0x33F44336, 
    ).also { Log.d("ThemePreset", "TechAI_INRERNET 主题已加载。") }
